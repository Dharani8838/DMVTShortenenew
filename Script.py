class script(object):   
    ...
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴 : {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : <a href=https://t.me/itzmrdv>MR DV</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈 : 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴 : 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴 : 𝙼𝙾𝙽𝙶𝙾-𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁 : 𝙰𝙽𝚈𝚆𝙷𝙴𝚁𝙴
✯ 𝙱𝚄𝙸𝙻𝙳 𝚅𝙴𝚁𝚂𝙸𝙾𝙽: 𝙿𝚁𝙾𝙵𝙴𝚂𝚂𝙾𝚁-𝙱𝙾𝚃 𝚟3.0.0"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 𝙲𝙻𝙸𝙲𝙺 𝙷𝙴𝚁 👉 :<a href=https://github.com/Dharani8838/DMVTShortenenew</a>

<b>DEVS:</b>
- 𝙳𝚎𝚟 1<a href=https://t.me/itzmrdv>MR DV</a>
- 𝙳𝚎𝚟 2<a href=https://t.me/kuttypaiyan3>Dharan</a>"""
...
<code>/batch https://t.me/DailyMvTamil https://t.me/dailymvtamil</code>

𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://t.me/itzmrdv><b>MR DV</b></a>"""
    
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and Dharan  will respond whenever a keyword is found the message
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 :- <a href=https://t.me/itzmrdv>MR DV</a>**"""
...
𝖬𝖺𝖽𝖾 𝖻𝗒 <a href=https://t.me/itzmrdv>MR DV</a>"""
...
◉ /purge :- Delete All Messages From The Replied To Message, To The Current Message"""
    ...
    ADMIN_REQUIRED = """❗<b>அந்த Admin நான் எங்கும் செல்லமாட்டேன் Bii..Add Me Again with all admin rights.</b>"""
      
    DKICK = """✔️ Kicked {} Deleted Accounts Successfully."""
      
    FETCHING_INFO = """<b>இப்போது அதையெல்லாம் தட்டவும்ം...</b>"""
